...
import FuseSettings from '@root/@fuse/core/FuseSettings/FuseSettings';
import FuseSvgIcon from '@root/@fuse/core/FuseSvgIcon';
import FuseSettingsViewerDialog from '@root/@fuse/theme-layouts/shared-components/FuseSettingsViewerDialog';
...
function SettingsPanel(props: SettingsPanelProps) {
	...
	return (
		<StyledDialog
			...
			{...settingsHandlers}
		>
			<FuseScrollbars className="space-y-32 p-16 sm:p-32">
				<IconButton
